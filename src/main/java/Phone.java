...
public class Phone {
	 ...
	 * 此处应更改为自己的adb目录
	 */
	private static final String ADB_PATH = LoadProperties.getProperty("ADB_PATH");
	private static final String HERO_PATH = LoadProperties.getProperty("HERO_PATH");
